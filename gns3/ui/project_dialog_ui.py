...
#
# Created: Sat Aug 20 10:25:55 2016
...
class Ui_ProjectDialog(object):
    ...
    def retranslateUi(self, ProjectDialog):
        ...
        self.uiOpenProjectGroupBox.setTitle(_translate("ProjectDialog", "Open project from disk"))
        ...
        self.uiProjectTabWidget.setTabText(self.uiProjectTabWidget.indexOf(self.tab), _translate("ProjectDialog", "Local project"))
