...
"")
        ...
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/icons/export_config.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.uiExportProjectAction.setIcon(icon30)
        self.uiExportProjectAction.setObjectName("uiExportProjectAction")
        self.uiImportProjectAction = QtWidgets.QAction(MainWindow)
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/icons/import_config.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.uiImportProjectAction.setIcon(icon31)
        ...
        self.uiEditReadmeAction.setIcon(icon32)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/icons/delete.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.uiDeleteProjectAction.setIcon(icon33)
        self.uiDeleteProjectAction.setObjectName("uiDeleteProjectAction")
        self.uiViewGridAction = QtWidgets.QAction(MainWindow)
        self.uiViewGridAction.setCheckable(True)
        self.uiViewGridAction.setObjectName("uiViewGridAction")
        ...
        self.uiViewMenu.addAction(self.uiViewGridAction)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.uiViewGridAction.setText(_translate("MainWindow", "View grid"))
