...
"")
        ...
        self.uiShowReadmeAction = QtGui.QAction(parent=MainWindow)
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/icons/edit.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.uiShowReadmeAction.setIcon(icon31)
        self.uiShowReadmeAction.setObjectName("uiShowReadmeAction")
        ...
        self.uiImageManagementAction = QtGui.QAction(parent=MainWindow)
        ...
        self.uiResetConsoleAllAction1 = QtGui.QAction(parent=MainWindow)
        self.uiResetConsoleAllAction1.setObjectName("uiResetConsoleAllAction1")
        ...
        self.uiFileMenu.addAction(self.uiImageManagementAction)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.uiShowReadmeAction.setText(_translate("MainWindow", "Show readme"))
        ...
        self.uiResetConsoleAllAction1.setText(_translate("MainWindow", "Reset all console connections"))
