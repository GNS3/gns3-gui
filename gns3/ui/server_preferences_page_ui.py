...
#
# Created: Fri Mar 25 18:53:36 2016
...
class Ui_ServerPreferencesPageWidget(object):
    def setupUi(self, ServerPreferencesPageWidget):
        ...
        ServerPreferencesPageWidget.resize(526, 650)
        ...
        self.gridLayout_2.addWidget(self.uiVMListComboBox, 1, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.uiRefreshPushButton, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.uiShutdownCheckBox, 4, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.uiHeadlessCheckBox, 3, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.uiAdjustLocalServerIPCheckBox, 5, 0, 1, 2)
        ...
        self.horizontalLayout_4.addWidget(self.uiLocalGNS3VMPortLabel)
        ...
        self.horizontalLayout_4.addWidget(self.uiLocalGNS3VMPortSpinBox)
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.uiRemoteGNS3VMSettingsGroupBox)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.uiRemoteGNS3VMProtocolLabel = QtWidgets.QLabel(self.uiRemoteGNS3VMSettingsGroupBox)
        self.uiRemoteGNS3VMProtocolLabel.setObjectName("uiRemoteGNS3VMProtocolLabel")
        self.gridLayout_3.addWidget(self.uiRemoteGNS3VMProtocolLabel, 0, 0, 1, 1)
        self.uiRemoteGNS3VMProtocolComboBox = QtWidgets.QComboBox(self.uiRemoteGNS3VMSettingsGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.uiRemoteGNS3VMProtocolComboBox.sizePolicy().hasHeightForWidth())
        self.uiRemoteGNS3VMProtocolComboBox.setSizePolicy(sizePolicy)
        self.uiRemoteGNS3VMProtocolComboBox.setObjectName("uiRemoteGNS3VMProtocolComboBox")
        self.uiRemoteGNS3VMProtocolComboBox.addItem("")
        self.uiRemoteGNS3VMProtocolComboBox.addItem("")
        self.gridLayout_3.addWidget(self.uiRemoteGNS3VMProtocolComboBox, 0, 1, 1, 1)
        self.uiRemoteGNS3VMHostLabel = QtWidgets.QLabel(self.uiRemoteGNS3VMSettingsGroupBox)
        self.uiRemoteGNS3VMHostLabel.setObjectName("uiRemoteGNS3VMHostLabel")
        self.gridLayout_3.addWidget(self.uiRemoteGNS3VMHostLabel, 1, 0, 1, 1)
        self.uiRemoteGNS3VMHostLineEdit = QtWidgets.QLineEdit(self.uiRemoteGNS3VMSettingsGroupBox)
        self.uiRemoteGNS3VMHostLineEdit.setObjectName("uiRemoteGNS3VMHostLineEdit")
        self.gridLayout_3.addWidget(self.uiRemoteGNS3VMHostLineEdit, 1, 1, 1, 1)
        self.uiRemoteGNS3VMPortLabel = QtWidgets.QLabel(self.uiRemoteGNS3VMSettingsGroupBox)
        self.uiRemoteGNS3VMPortLabel.setObjectName("uiRemoteGNS3VMPortLabel")
        self.gridLayout_3.addWidget(self.uiRemoteGNS3VMPortLabel, 2, 0, 1, 1)
        self.uiRemoteGNS3VMPortSpinBox = QtWidgets.QSpinBox(self.uiRemoteGNS3VMSettingsGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.uiRemoteGNS3VMPortSpinBox.sizePolicy().hasHeightForWidth())
        self.uiRemoteGNS3VMPortSpinBox.setSizePolicy(sizePolicy)
        self.uiRemoteGNS3VMPortSpinBox.setSuffix(" TCP")
        self.uiRemoteGNS3VMPortSpinBox.setMaximum(65535)
        self.uiRemoteGNS3VMPortSpinBox.setProperty("value", 3080)
        self.uiRemoteGNS3VMPortSpinBox.setObjectName("uiRemoteGNS3VMPortSpinBox")
        self.gridLayout_3.addWidget(self.uiRemoteGNS3VMPortSpinBox, 2, 1, 1, 1)
        self.uiRemoteGNS3VMUserLabel = QtWidgets.QLabel(self.uiRemoteGNS3VMSettingsGroupBox)
        self.uiRemoteGNS3VMUserLabel.setObjectName("uiRemoteGNS3VMUserLabel")
        self.gridLayout_3.addWidget(self.uiRemoteGNS3VMUserLabel, 3, 0, 1, 1)
        self.uiRemoteGNS3VMUserLineEdit = QtWidgets.QLineEdit(self.uiRemoteGNS3VMSettingsGroupBox)
        self.uiRemoteGNS3VMUserLineEdit.setToolTip("")
        self.uiRemoteGNS3VMUserLineEdit.setObjectName("uiRemoteGNS3VMUserLineEdit")
        self.gridLayout_3.addWidget(self.uiRemoteGNS3VMUserLineEdit, 3, 1, 1, 1)
        self.uiRemoteGNS3VMPasswordLabel = QtWidgets.QLabel(self.uiRemoteGNS3VMSettingsGroupBox)
        self.uiRemoteGNS3VMPasswordLabel.setObjectName("uiRemoteGNS3VMPasswordLabel")
        self.gridLayout_3.addWidget(self.uiRemoteGNS3VMPasswordLabel, 4, 0, 1, 1)
        self.uiRemoteGNS3VMPasswordLineEdit = QtWidgets.QLineEdit(self.uiRemoteGNS3VMSettingsGroupBox)
        self.uiRemoteGNS3VMPasswordLineEdit.setInputMethodHints(QtCore.Qt.ImhHiddenText|QtCore.Qt.ImhNoAutoUppercase|QtCore.Qt.ImhNoPredictiveText)
        self.uiRemoteGNS3VMPasswordLineEdit.setEchoMode(QtWidgets.QLineEdit.Password)
        self.uiRemoteGNS3VMPasswordLineEdit.setObjectName("uiRemoteGNS3VMPasswordLineEdit")
        self.gridLayout_3.addWidget(self.uiRemoteGNS3VMPasswordLineEdit, 4, 1, 1, 1)
        ...
        self.uiRemoteServerHostLineEdit = QtWidgets.QLineEdit(self.uiRemoteTabWidget)
        self.uiRemoteServerHostLineEdit.setObjectName("uiRemoteServerHostLineEdit")
        self.gridLayout_5.addWidget(self.uiRemoteServerHostLineEdit, 2, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.uiRemoteServerUserLineEdit, 4, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.uiRemoteServerUserLabel, 4, 0, 1, 1)
        ...
        self.gridLayout_5.addLayout(self.horizontalLayout_3, 6, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.uiRemoteServerPasswordLabel, 5, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.uiRemoteServerPasswordLineEdit, 5, 1, 1, 1)
        ...
        ServerPreferencesPageWidget.setTabOrder(self.uiRemoteServerProtocolComboBox, self.uiRemoteServerHostLineEdit)
        ServerPreferencesPageWidget.setTabOrder(self.uiRemoteServerHostLineEdit, self.uiRemoteServerPortSpinBox)
    ...
    def retranslateUi(self, ServerPreferencesPageWidget):
        ...
        self.uiRemoteGNS3VMProtocolLabel.setText(_translate("ServerPreferencesPageWidget", "Protocol:"))
        self.uiRemoteGNS3VMProtocolComboBox.setProperty("currentText", _translate("ServerPreferencesPageWidget", "HTTP"))
        self.uiRemoteGNS3VMProtocolComboBox.setItemText(0, _translate("ServerPreferencesPageWidget", "HTTP"))
        self.uiRemoteGNS3VMProtocolComboBox.setItemText(1, _translate("ServerPreferencesPageWidget", "HTTPS"))
        self.uiRemoteGNS3VMHostLabel.setText(_translate("ServerPreferencesPageWidget", "Host:"))
        self.uiRemoteGNS3VMHostLineEdit.setText(_translate("ServerPreferencesPageWidget", "192.168.56.101"))
        self.uiRemoteGNS3VMPortLabel.setText(_translate("ServerPreferencesPageWidget", "Port:"))
        self.uiRemoteGNS3VMUserLabel.setText(_translate("ServerPreferencesPageWidget", "User:"))
        self.uiRemoteGNS3VMPasswordLabel.setText(_translate("ServerPreferencesPageWidget", "Password:"))
        ...
        self.uiRemoteServerHostLineEdit.setText(_translate("ServerPreferencesPageWidget", "192.168.56.101"))
