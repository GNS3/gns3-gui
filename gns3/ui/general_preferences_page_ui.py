...
class Ui_GeneralPreferencesPageWidget(object):
    def setupUi(self, GeneralPreferencesPageWidget):
        ...
        GeneralPreferencesPageWidget.resize(622, 722)
        ...
        self.uiImagesPathLabel = QtWidgets.QLabel(self.groupBox)
        ...
        self.uiImagesPathLineEdit = QtWidgets.QLineEdit(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.uiImagesPathToolButton = QtWidgets.QToolButton(self.groupBox)
        ...
        self.uiImageDirectoriesListWidget = QtWidgets.QListWidget(self.groupBox)
        self.uiImageDirectoriesListWidget.setLineWidth(0)
        self.uiImageDirectoriesListWidget.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        ...
        self.uiImageDirectoriesAddPushButton = QtWidgets.QPushButton(self.groupBox)
        ...
        self.uiImageDirectoriesDeletePushButton = QtWidgets.QPushButton(self.groupBox)
        ...
        self.uiMiscTabWidget.addTab(self.tab_2, "")
    ...
    def retranslateUi(self, GeneralPreferencesPageWidget):
        ...
        self.groupBox.setTitle(_translate("GeneralPreferencesPageWidget", "Local paths"))
        ...
        self.label_2.setText(_translate("GeneralPreferencesPageWidget", "Additional binary images directories search locations:"))
        self.label_4.setText(_translate("GeneralPreferencesPageWidget", "<html><head/><body><p><span style=\" font-weight:600;\">WARNING:</span> Add only directories with images. The scan process could consume a lot of CPU resources.</p></body></html>"))
        ...
        self.uiMiscTabWidget.setTabText(self.uiMiscTabWidget.indexOf(self.tab_2), _translate("GeneralPreferencesPageWidget", "Images"))
