...
class Ui_GeneralPreferencesPageWidget(object):
    def setupUi(self, GeneralPreferencesPageWidget):
        ...
        GeneralPreferencesPageWidget.resize(963, 1168)
        ...
        self.uiDefaultLinkGroupBox = QtWidgets.QGroupBox(self.uiSceneTab)
        self.uiDefaultLinkGroupBox.setObjectName("uiDefaultLinkGroupBox")
        self.gridLayout_12 = QtWidgets.QGridLayout(self.uiDefaultLinkGroupBox)
        self.gridLayout_12.setObjectName("gridLayout_12")
        self.uiDefaultLinkWidthLabel = QtWidgets.QLabel(self.uiDefaultLinkGroupBox)
        self.uiDefaultLinkWidthLabel.setObjectName("uiDefaultLinkWidthLabel")
        self.gridLayout_12.addWidget(self.uiDefaultLinkWidthLabel, 0, 0, 1, 1)
        self.uiDefaultLinkWidthSpinBox = QtWidgets.QSpinBox(self.uiDefaultLinkGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.uiDefaultLinkWidthSpinBox.sizePolicy().hasHeightForWidth())
        self.uiDefaultLinkWidthSpinBox.setSizePolicy(sizePolicy)
        self.uiDefaultLinkWidthSpinBox.setMinimum(1)
        self.uiDefaultLinkWidthSpinBox.setMaximum(10)
        self.uiDefaultLinkWidthSpinBox.setProperty("value", 2)
        self.uiDefaultLinkWidthSpinBox.setObjectName("uiDefaultLinkWidthSpinBox")
        self.gridLayout_12.addWidget(self.uiDefaultLinkWidthSpinBox, 0, 1, 1, 1)
        self.uiDefaultLinkColorLabel = QtWidgets.QLabel(self.uiDefaultLinkGroupBox)
        self.uiDefaultLinkColorLabel.setObjectName("uiDefaultLinkColorLabel")
        self.gridLayout_12.addWidget(self.uiDefaultLinkColorLabel, 1, 0, 1, 1)
        self.uiDefaultLinkColorPushButton = QtWidgets.QPushButton(self.uiDefaultLinkGroupBox)
        self.uiDefaultLinkColorPushButton.setObjectName("uiDefaultLinkColorPushButton")
        self.gridLayout_12.addWidget(self.uiDefaultLinkColorPushButton, 1, 1, 1, 1)
        self.uiDefaultLinkStyleLabel = QtWidgets.QLabel(self.uiDefaultLinkGroupBox)
        self.uiDefaultLinkStyleLabel.setObjectName("uiDefaultLinkStyleLabel")
        self.gridLayout_12.addWidget(self.uiDefaultLinkStyleLabel, 2, 0, 1, 1)
        self.uiDefaultLinkStyleComboBox = QtWidgets.QComboBox(self.uiDefaultLinkGroupBox)
        self.uiDefaultLinkStyleComboBox.setObjectName("uiDefaultLinkStyleComboBox")
        self.uiDefaultLinkStyleComboBox.addItem("")
        self.uiDefaultLinkStyleComboBox.addItem("")
        self.uiDefaultLinkStyleComboBox.addItem("")
        self.uiDefaultLinkStyleComboBox.addItem("")
        self.uiDefaultLinkStyleComboBox.addItem("")
        self.uiDefaultLinkStyleComboBox.addItem("")
        self.gridLayout_12.addWidget(self.uiDefaultLinkStyleComboBox, 2, 1, 1, 1)
        self.gridLayout_3.addWidget(self.uiDefaultLinkGroupBox, 16, 0, 1, 3)
        spacerItem9 = QtWidgets.QSpacerItem(20, 5, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_3.addItem(spacerItem9, 18, 0, 1, 1)
        ...
        self.uiAutoOpenReadmeCheckBox = QtWidgets.QCheckBox(self.uiMiscTab)
        self.uiAutoOpenReadmeCheckBox.setChecked(True)
        self.uiAutoOpenReadmeCheckBox.setObjectName("uiAutoOpenReadmeCheckBox")
        self.verticalLayout_2.addWidget(self.uiAutoOpenReadmeCheckBox)
        ...
        GeneralPreferencesPageWidget.setTabOrder(self.uiDefaultNoteColorPushButton, self.uiDefaultLinkWidthSpinBox)
        GeneralPreferencesPageWidget.setTabOrder(self.uiDefaultLinkWidthSpinBox, self.uiDefaultLinkColorPushButton)
        GeneralPreferencesPageWidget.setTabOrder(self.uiDefaultLinkColorPushButton, self.uiDefaultLinkStyleComboBox)
        GeneralPreferencesPageWidget.setTabOrder(self.uiDefaultLinkStyleComboBox, self.uiCheckForUpdateCheckBox)
        ...
        GeneralPreferencesPageWidget.setTabOrder(self.uiMultiProfilesCheckBox, self.uiRestoreDefaultsPushButton)
    ...
    def retranslateUi(self, GeneralPreferencesPageWidget):
        ...
        self.uiDefaultLinkGroupBox.setTitle(_translate("GeneralPreferencesPageWidget", "Default link style"))
        ...
        self.uiDefaultLinkColorPushButton.setText(_translate("GeneralPreferencesPageWidget", "Select color"))
        self.uiDefaultLinkStyleLabel.setText(_translate("GeneralPreferencesPageWidget", "Line style:"))
        self.uiDefaultLinkStyleComboBox.setItemText(0, _translate("GeneralPreferencesPageWidget", "Solid"))
        self.uiDefaultLinkStyleComboBox.setItemText(1, _translate("GeneralPreferencesPageWidget", "Dash"))
        self.uiDefaultLinkStyleComboBox.setItemText(2, _translate("GeneralPreferencesPageWidget", "Dot"))
        self.uiDefaultLinkStyleComboBox.setItemText(3, _translate("GeneralPreferencesPageWidget", "Dash Dot"))
        self.uiDefaultLinkStyleComboBox.setItemText(4, _translate("GeneralPreferencesPageWidget", "Dash Dot Dot"))
        self.uiDefaultLinkStyleComboBox.setItemText(5, _translate("GeneralPreferencesPageWidget", "Invisible"))
        ...
        self.uiAutoOpenReadmeCheckBox.setText(_translate("GeneralPreferencesPageWidget", "Automatically open project README files"))
