...
class Ui_GeneralPreferencesPageWidget(object):
    def setupUi(self, GeneralPreferencesPageWidget):
        ...
        GeneralPreferencesPageWidget.resize(1324, 1038)
        ...
        self.gridLayout_3.addWidget(self.uiSceneHeightLabel, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.uiDrawingGridSizeLabel, 6, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.uiDrawLinkStatusPointsCheckBox, 9, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.uiShowInterfaceLabelsOnNewProject, 10, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.uiShowGridOnNewProject, 11, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.uiSnapToGridOnNewProject, 12, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.uiLimitSizeNodeSymbolCheckBox, 13, 0, 1, 1)
        self.uiLabelPreviewLabel = QtWidgets.QLabel(self.uiSceneTab)
        self.uiLabelPreviewLabel.setObjectName("uiLabelPreviewLabel")
        self.gridLayout_3.addWidget(self.uiLabelPreviewLabel, 14, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.uiDefaultLabelStylePlainTextEdit, 15, 0, 1, 2)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_5, 16, 0, 1, 2)
        self.uiNotePreviewLabel = QtWidgets.QLabel(self.uiSceneTab)
        self.uiNotePreviewLabel.setObjectName("uiNotePreviewLabel")
        self.gridLayout_3.addWidget(self.uiNotePreviewLabel, 17, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.uiDefaultNoteStylePlainTextEdit, 18, 0, 1, 2)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_14, 19, 0, 1, 2)
        spacerItem8 = QtWidgets.QSpacerItem(20, 5, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_3.addItem(spacerItem8, 20, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.uiSceneWidthSpinBox, 1, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.uiSceneHeightSpinBox, 3, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.uiNodeGridSizeSpinBox, 5, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.uiDrawingGridSizeSpinBox, 7, 0, 1, 2)
