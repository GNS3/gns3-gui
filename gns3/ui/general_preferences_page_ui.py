...
class Ui_GeneralPreferencesPageWidget(object):
    def setupUi(self, GeneralPreferencesPageWidget):
        ...
        self.gridLayout_3.addWidget(self.uiSceneWidthSpinBox, 1, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.uiLabelPreviewLabel, 9, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.uiDefaultLabelStylePlainTextEdit, 10, 0, 1, 2)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_5, 11, 0, 1, 2)
        self.uiNotePreviewLabel = QtWidgets.QLabel(self.uiSceneTab)
        self.uiNotePreviewLabel.setObjectName("uiNotePreviewLabel")
        self.gridLayout_3.addWidget(self.uiNotePreviewLabel, 12, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.uiDefaultNoteStylePlainTextEdit, 13, 0, 1, 2)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_14, 14, 0, 1, 2)
        spacerItem8 = QtWidgets.QSpacerItem(20, 5, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_3.addItem(spacerItem8, 15, 1, 1, 1)
