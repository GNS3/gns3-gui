...
class Ui_SetupWizard(object):
    ...
    def setupUi(self, SetupWizard):
        ...
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.uiServerWizardPage)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.uiLogoLabel = QtWidgets.QLabel(self.uiServerWizardPage)
        ...
        self.horizontalLayout_5.addWidget(self.uiLogoLabel)
        ...
        self.verticalLayout_5.addWidget(self.uiShowCheckBox)
        ...
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.uiRemoteControllerWizardPage)
        ...
        self.label_8 = QtWidgets.QLabel(self.uiRemoteControllerWizardPage)
    ...
    def retranslateUi(self, SetupWizard):
        ...
        self.label.setText(_translate("SetupWizard", "This will require an additional VM (GNS3 VM available for free) ."))
        ...
        self.uiLocalLabel.setText(_translate("SetupWizard", "Require IOS images <= C7200"))
        self.uiRemoteControllerRadioButton.setText(_translate("SetupWizard", "Run everything on a remote server (advanced usage)"))
        self.label_2.setText(_translate("SetupWizard", "The server will be on a remote server and could be share with multiple users."))
        ...
        self.label_8.setText(_translate("SetupWizard", "Auth:"))
