...
class Ui_NewTemplateWizard(object):
    def setupUi(self, NewTemplateWizard):
        ...
        NewTemplateWizard.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.uiImportApplianceFromServerRadioButton = QtWidgets.QRadioButton(parent=self.uiSelectTemplateSourceWizardPage)
        ...
        self.uiImportApplianceFromFileRadioButton = QtWidgets.QRadioButton(parent=self.uiSelectTemplateSourceWizardPage)
        ...
        self.uiCreateTemplateManuallyRadioButton = QtWidgets.QRadioButton(parent=self.uiSelectTemplateSourceWizardPage)
        ...
        self.uiFilterLineEdit = QtWidgets.QLineEdit(parent=self.uiApplianceFromServerWizardPage)
        self.uiFilterLineEdit.setObjectName("uiFilterLineEdit")
        self.verticalLayout_2.addWidget(self.uiFilterLineEdit)
        self.uiAppliancesTreeWidget = QtWidgets.QTreeWidget(parent=self.uiApplianceFromServerWizardPage)
        self.uiAppliancesTreeWidget.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
