...
class Ui_NewApplianceWizard(object):
    def setupUi(self, NewApplianceWizard):
        ...
        NewApplianceWizard.setWindowModality(QtCore.Qt.ApplicationModal)
        ...
        self.uiApplianceTemplatesTreeWidget.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
    ...
    def retranslateUi(self, NewApplianceWizard):
        ...
        self.uiAddApplianceFromServerRadioButton.setText(_translate("NewApplianceWizard", "&Add appliances from the GNS3 server (recommended)"))
        ...
        self.uiApplianceFromServerWizardPage.setSubTitle(_translate("NewApplianceWizard", "Please select the appliances to install. Update will request the server to download appliance templates from our online registry."))
