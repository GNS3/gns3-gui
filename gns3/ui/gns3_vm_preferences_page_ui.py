...
class Ui_GNS3VMPreferencesPageWidget(object):
    def setupUi(self, GNS3VMPreferencesPageWidget):
        ...
        self.uiEnableVMCheckBox = QtWidgets.QCheckBox(parent=GNS3VMPreferencesPageWidget)
        ...
        self.uiVirtualizationGroupBox = QtWidgets.QGroupBox(parent=GNS3VMPreferencesPageWidget)
        ...
        self.uiGNS3VMEngineComboBox = QtWidgets.QComboBox(parent=self.uiVirtualizationGroupBox)
        ...
        self.uiEngineDescriptionLabel = QtWidgets.QLabel(parent=self.uiVirtualizationGroupBox)
        ...
        self.uiGNS3VMSettingsGroupBox = QtWidgets.QGroupBox(parent=GNS3VMPreferencesPageWidget)
        ...
        self.uiHeadlessCheckBox = QtWidgets.QCheckBox(parent=self.uiGNS3VMSettingsGroupBox)
        self.uiHeadlessCheckBox.setObjectName("uiHeadlessCheckBox")
        self.gridLayout.addWidget(self.uiHeadlessCheckBox, 3, 0, 1, 2)
        self.uiActionCloseLabel = QtWidgets.QLabel(parent=self.uiGNS3VMSettingsGroupBox)
        self.uiActionCloseLabel.setObjectName("uiActionCloseLabel")
        self.gridLayout.addWidget(self.uiActionCloseLabel, 11, 0, 1, 2)
        self.uiWhenExitKeepRadioButton = QtWidgets.QRadioButton(parent=self.uiGNS3VMSettingsGroupBox)
        ...
        self.uiWhenExitSuspendRadioButton = QtWidgets.QRadioButton(parent=self.uiGNS3VMSettingsGroupBox)
        ...
        self.uiVMNameLabel = QtWidgets.QLabel(parent=self.uiGNS3VMSettingsGroupBox)
        self.uiVMNameLabel.setObjectName("uiVMNameLabel")
        self.gridLayout.addWidget(self.uiVMNameLabel, 0, 0, 1, 1)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.uiVMListComboBox = QtWidgets.QComboBox(parent=self.uiGNS3VMSettingsGroupBox)
        ...
        self.uiRefreshPushButton = QtWidgets.QPushButton(parent=self.uiGNS3VMSettingsGroupBox)
        ...
        self.uiWhenExitStopRadioButton = QtWidgets.QRadioButton(parent=self.uiGNS3VMSettingsGroupBox)
        ...
        self.uiRamLabel = QtWidgets.QLabel(parent=self.uiGNS3VMSettingsGroupBox)
        self.uiRamLabel.setObjectName("uiRamLabel")
        self.gridLayout.addWidget(self.uiRamLabel, 6, 0, 1, 1)
        self.uiRamSpinBox = QtWidgets.QSpinBox(parent=self.uiGNS3VMSettingsGroupBox)
        ...
        self.uiPortLabel = QtWidgets.QLabel(parent=self.uiGNS3VMSettingsGroupBox)
        self.uiPortLabel.setObjectName("uiPortLabel")
        self.gridLayout.addWidget(self.uiPortLabel, 2, 0, 1, 1)
        self.uiPortSpinBox = QtWidgets.QSpinBox(parent=self.uiGNS3VMSettingsGroupBox)
        ...
        self.uiAllocatevCPUsRAMCheckBox = QtWidgets.QCheckBox(parent=self.uiGNS3VMSettingsGroupBox)
        ...
        self.uiCpuLabel = QtWidgets.QLabel(parent=self.uiGNS3VMSettingsGroupBox)
        self.uiCpuLabel.setObjectName("uiCpuLabel")
        self.gridLayout.addWidget(self.uiCpuLabel, 5, 0, 1, 1)
        self.uiCpuSpinBox = QtWidgets.QSpinBox(parent=self.uiGNS3VMSettingsGroupBox)
