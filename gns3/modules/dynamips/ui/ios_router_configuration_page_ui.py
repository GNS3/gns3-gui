...
class Ui_iosRouterConfigPageWidget(object):
    def setupUi(self, iosRouterConfigPageWidget):
        ...
        iosRouterConfigPageWidget.resize(600, 601)
        ...
        self.uiConsoleTypeLabel = QtWidgets.QLabel(self.uiGeneralPageWidget)
        ...
        self.uiConsoleTypeComboBox = QtWidgets.QComboBox(self.uiGeneralPageWidget)
        ...
        self.uiConsoleAutoStartCheckBox = QtWidgets.QCheckBox(self.uiGeneralPageWidget)
    ...
    def retranslateUi(self, iosRouterConfigPageWidget):
        ...
        self.uiAuxTypeLabel.setText(_translate("iosRouterConfigPageWidget", "Auxiliary console type:"))
