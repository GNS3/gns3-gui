...
class Ui_IOSRouterWizard(object):
    def setupUi(self, IOSRouterWizard):
        ...
        IOSRouterWizard.resize(514, 397)
        ...
        self.uiIOSImageLabel = QtGui.QLabel(self.uiNameImageWizardPage)
        ...
        self.uiIOSImageLineEdit = QtGui.QLineEdit(self.uiNameImageWizardPage)
        ...
        self.uiIOSImageToolButton = QtGui.QToolButton(self.uiNameImageWizardPage)
        ...
        self.uiPlatformComboBox = QtGui.QComboBox(self.uiNameImageWizardPage)
        self.uiPlatformComboBox.setObjectName(_fromUtf8("uiPlatformComboBox"))
        self.gridLayout.addWidget(self.uiPlatformComboBox, 2, 1, 1, 1)
        self.uiChassisLabel = QtGui.QLabel(self.uiNameImageWizardPage)
        self.uiChassisLabel.setObjectName(_fromUtf8("uiChassisLabel"))
        self.gridLayout.addWidget(self.uiChassisLabel, 3, 0, 1, 1)
        self.uiChassisComboBox = QtGui.QComboBox(self.uiNameImageWizardPage)
        self.uiChassisComboBox.setObjectName(_fromUtf8("uiChassisComboBox"))
        self.gridLayout.addWidget(self.uiChassisComboBox, 3, 1, 1, 1)
        IOSRouterWizard.addPage(self.uiNameImageWizardPage)
    ...
    def retranslateUi(self, IOSRouterWizard):
        ...
        self.uiNameImageWizardPage.setTitle(_translate("IOSRouterWizard", "Name and image", None))
        ...
        self.uiWicWizardPage.setSubTitle(_translate("IOSRouterWizard", "Please choose the WIC modules to insert in the router.", None))
