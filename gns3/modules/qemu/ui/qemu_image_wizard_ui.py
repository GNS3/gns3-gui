...
class Ui_QemuImageWizard(object):
    def setupUi(self, QemuImageWizard):
        ...
        QemuImageWizard.setWizardStyle(QtWidgets.QWizard.WizardStyle.ModernStyle)
        ...
        self.uiBinaryLabel = QtWidgets.QLabel(parent=self.uiBinaryWizardPage)
        self.uiBinaryLabel.setObjectName("uiBinaryLabel")
        self.gridLayout.addWidget(self.uiBinaryLabel, 0, 0, 1, 1)
        self.uiBinaryComboBox = QtWidgets.QComboBox(parent=self.uiBinaryWizardPage)
        ...
        self.uiFormatLabel = QtWidgets.QLabel(parent=self.uiBinaryWizardPage)
        self.uiFormatLabel.setObjectName("uiFormatLabel")
        self.gridLayout.addWidget(self.uiFormatLabel, 1, 0, 1, 1)
        self.verticalLayout_3 = QtWidgets.QVBoxLayout()
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.uiFormatQcow2Radio = QtWidgets.QRadioButton(parent=self.uiBinaryWizardPage)
        ...
        self.uiFormatQcowRadio = QtWidgets.QRadioButton(parent=self.uiBinaryWizardPage)
        ...
        self.uiFormatVhdRadio = QtWidgets.QRadioButton(parent=self.uiBinaryWizardPage)
        ...
        self.uiFormatVdiRadio = QtWidgets.QRadioButton(parent=self.uiBinaryWizardPage)
        ...
        self.uiFormatVmdkRadio = QtWidgets.QRadioButton(parent=self.uiBinaryWizardPage)
        ...
        self.uiFormatRawRadio = QtWidgets.QRadioButton(parent=self.uiBinaryWizardPage)
        ...
        self.uiSizeOptionsGroupBox = QtWidgets.QGroupBox(parent=self.uiQcow2OptionsWizardPage)
        ...
        self.uiPreallocationLabel = QtWidgets.QLabel(parent=self.uiSizeOptionsGroupBox)
        ...
        self.uiQcow2PreallocationOffRadio = QtWidgets.QRadioButton(parent=self.uiSizeOptionsGroupBox)
        ...
        self.uiQcow2PreallocationMetadataRadio = QtWidgets.QRadioButton(parent=self.uiSizeOptionsGroupBox)
        ...
        self.uiQcow2PreallocationFallocRadio = QtWidgets.QRadioButton(parent=self.uiSizeOptionsGroupBox)
        ...
        self.uiQcow2PreallocationFullRadio = QtWidgets.QRadioButton(parent=self.uiSizeOptionsGroupBox)
        ...
        self.uiClusterSizeLabel = QtWidgets.QLabel(parent=self.uiSizeOptionsGroupBox)
        self.uiClusterSizeLabel.setObjectName("uiClusterSizeLabel")
        self.gridLayout_3.addWidget(self.uiClusterSizeLabel, 1, 0, 1, 1)
        self.uiQcow2ClusterSizeComboBox = QtWidgets.QComboBox(parent=self.uiSizeOptionsGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.uiRefcountsGroupBox = QtWidgets.QGroupBox(parent=self.uiQcow2OptionsWizardPage)
        ...
        self.uiRefcountEntrySizeLabel = QtWidgets.QLabel(parent=self.uiRefcountsGroupBox)
        ...
        self.uiRefcountEntrySizeComboBox = QtWidgets.QComboBox(parent=self.uiRefcountsGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.uiLazyRefcountsCheckBox = QtWidgets.QCheckBox(parent=self.uiRefcountsGroupBox)
        ...
        self.uiVhdFileSizeModeGroupBox = QtWidgets.QGroupBox(parent=self.uiVhdOptionsWizardPage)
        ...
        self.uiVhdFileSizeModeDynamicRadio = QtWidgets.QRadioButton(parent=self.uiVhdFileSizeModeGroupBox)
        ...
        self.uiVhdFileSizeModeFixedRadio = QtWidgets.QRadioButton(parent=self.uiVhdFileSizeModeGroupBox)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(293, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.uiVdiFileSizeModeGroupBox = QtWidgets.QGroupBox(parent=self.uiVdiOptionsWizardPage)
        ...
        self.uiVdiFileSizeModeDynamicRadio = QtWidgets.QRadioButton(parent=self.uiVdiFileSizeModeGroupBox)
        ...
        self.uiVdiFileSizeModeFixedRadio = QtWidgets.QRadioButton(parent=self.uiVdiFileSizeModeGroupBox)
        ...
        self.uiVmdkAdapterTypeGroupBox = QtWidgets.QGroupBox(parent=self.uiVmdkOptionsWizardPage)
        ...
        self.uiVmdkAdapterTypeIdeRadio = QtWidgets.QRadioButton(parent=self.uiVmdkAdapterTypeGroupBox)
        ...
        self.uiVmdkAdapterTypeLsiRadio = QtWidgets.QRadioButton(parent=self.uiVmdkAdapterTypeGroupBox)
        ...
        self.uiVmdkAdapterTypeBusRadio = QtWidgets.QRadioButton(parent=self.uiVmdkAdapterTypeGroupBox)
        ...
        self.uiVmdkAdapterTypeEsxRadio = QtWidgets.QRadioButton(parent=self.uiVmdkAdapterTypeGroupBox)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(86, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_4.addItem(spacerItem3)
        self.verticalLayout_6.addWidget(self.uiVmdkAdapterTypeGroupBox)
        self.uiVmdkFileSizeModeGroupBox = QtWidgets.QGroupBox(parent=self.uiVmdkOptionsWizardPage)
        ...
        self.uiVmdkFileSizeModeSparseRadio = QtWidgets.QRadioButton(parent=self.uiVmdkFileSizeModeGroupBox)
        ...
        self.uiVmdkFileSizeModeFlatRadio = QtWidgets.QRadioButton(parent=self.uiVmdkFileSizeModeGroupBox)
        ...
        self.uiVmdkMiscGroupBox = QtWidgets.QGroupBox(parent=self.uiVmdkOptionsWizardPage)
        ...
        self.uiVmdkStreamOptimizedCheckBox = QtWidgets.QCheckBox(parent=self.uiVmdkMiscGroupBox)
        ...
        self.uiVmdkSplit2gCheckBox = QtWidgets.QCheckBox(parent=self.uiVmdkMiscGroupBox)
        ...
        self.uiVmdkZeroedGrainCheckBox = QtWidgets.QCheckBox(parent=self.uiVmdkMiscGroupBox)
        ...
        spacerItem5 = QtWidgets.QSpacerItem(36, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.uiLocationLabel = QtWidgets.QLabel(parent=self.uiSizeAndLocationWizardPage)
        ...
        self.uiLocationLineEdit = QtWidgets.QLineEdit(parent=self.uiSizeAndLocationWizardPage)
        self.uiLocationLineEdit.setObjectName("uiLocationLineEdit")
        self.horizontalLayout.addWidget(self.uiLocationLineEdit)
        self.uiLocationBrowseToolButton = QtWidgets.QToolButton(parent=self.uiSizeAndLocationWizardPage)
        ...
        self.uiSizeLabel = QtWidgets.QLabel(parent=self.uiSizeAndLocationWizardPage)
        self.uiSizeLabel.setObjectName("uiSizeLabel")
        self.gridLayout_4.addWidget(self.uiSizeLabel, 1, 0, 1, 1)
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.uiSizeSpinBox = QtWidgets.QSpinBox(parent=self.uiSizeAndLocationWizardPage)
        self.uiSizeSpinBox.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.UpDownArrows)
