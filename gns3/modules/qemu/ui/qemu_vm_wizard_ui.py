...
class Ui_QemuVMWizard(object):
    def setupUi(self, QemuVMWizard):
        ...
        self.uiQemuPlatformLabel = QtWidgets.QLabel(parent=self.uiPlatformMemoryWizardPage)
        self.uiQemuPlatformLabel.setObjectName("uiQemuPlatformLabel")
        self.gridLayout_2.addWidget(self.uiQemuPlatformLabel, 0, 0, 1, 1)
        self.uiQemuPlatformComboBox = QtWidgets.QComboBox(parent=self.uiPlatformMemoryWizardPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.uiRamLabel = QtWidgets.QLabel(parent=self.uiPlatformMemoryWizardPage)
        self.uiRamLabel.setObjectName("uiRamLabel")
        self.gridLayout_2.addWidget(self.uiRamLabel, 1, 0, 1, 1)
        self.uiRamSpinBox = QtWidgets.QSpinBox(parent=self.uiPlatformMemoryWizardPage)
