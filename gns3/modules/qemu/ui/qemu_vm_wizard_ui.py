...
# Form implementation generated from reading ui file 'gns3/modules/qemu/ui/qemu_vm_wizard.ui'
#
...
class Ui_QemuVMWizard(object):
    def setupUi(self, QemuVMWizard):
        ...
        self.uiSnapshotPath = QtWidgets.QWizardPage()
        self.uiSnapshotPath.setObjectName("uiSnapshotPath")
        self.gridLayoutWidget = QtWidgets.QWidget(self.uiSnapshotPath)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 621, 72))
        self.gridLayoutWidget.setObjectName("gridLayoutWidget")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.gridLayoutWidget)
        self.gridLayout_5.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.uiPathSnapshotLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.uiPathSnapshotLabel.setObjectName("uiPathSnapshotLabel")
        self.gridLayout_5.addWidget(self.uiPathSnapshotLabel, 0, 0, 1, 1)
        self.uiSnaphotPathLineEdit = QtWidgets.QLineEdit(self.gridLayoutWidget)
        self.uiSnaphotPathLineEdit.setObjectName("uiSnaphotPathLineEdit")
        self.gridLayout_5.addWidget(self.uiSnaphotPathLineEdit, 0, 1, 1, 1)
        QemuVMWizard.addPage(self.uiSnapshotPath)
    ...
    def retranslateUi(self, QemuVMWizard):
        ...
        self.uiSnapshotPath.setTitle(_translate("QemuVMWizard", "Path of snapshot"))
        self.uiSnapshotPath.setSubTitle(_translate("QemuVMWizard", "Please choose a path where the snapshot will be stored"))
        self.uiPathSnapshotLabel.setText(_translate("QemuVMWizard", "Path: "))
