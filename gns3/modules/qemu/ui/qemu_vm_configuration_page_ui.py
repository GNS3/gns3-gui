...
# Form implementation generated from reading ui file 'gns3/modules/qemu/ui/qemu_vm_configuration_page.ui'
#
...
class Ui_QemuVMConfigPageWidget(object):
    def setupUi(self, QemuVMConfigPageWidget):
        ...
        self.uiOnCloseLabel = QtWidgets.QLabel(self.uiGeneralSettingsTab)
        self.uiOnCloseLabel.setObjectName("uiOnCloseLabel")
        self.gridLayout_4.addWidget(self.uiOnCloseLabel, 8, 0, 1, 1)
        self.uiOnCloseComboBox = QtWidgets.QComboBox(self.uiGeneralSettingsTab)
        ...
        self.uiHdaDiskImageResizeToolButton = QtWidgets.QToolButton(self.uiHdaGroupBox)
        ...
        self.uiHdbDiskImageResizeToolButton = QtWidgets.QToolButton(self.uiHdbgroupBox)
        ...
        self.uiSnapshotPath = QtWidgets.QWidget()
        self.uiSnapshotPath.setObjectName("uiSnapshotPath")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.uiSnapshotPath)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 90, 891, 80))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.uiSnapshotPathLineEdit = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.uiSnapshotPathLineEdit.setObjectName("uiSnapshotPathLineEdit")
        self.verticalLayout_5.addWidget(self.uiSnapshotPathLineEdit)
        self.uiQemutabWidget.addTab(self.uiSnapshotPath, "")
        self.verticalLayout.addWidget(self.uiQemutabWidget)

        self.retranslateUi(QemuVMConfigPageWidget)
        self.uiQemutabWidget.setCurrentIndex(6)
...
"</body></html>"))
        ...
        self.uiQemutabWidget.setTabText(self.uiQemutabWidget.indexOf(self.uiSnapshotPath), _translate("QemuVMConfigPageWidget", "Snapshot Path"))
