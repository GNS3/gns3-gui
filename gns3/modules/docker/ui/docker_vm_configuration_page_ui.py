...
class Ui_dockerVMConfigPageWidget(object):
    def setupUi(self, dockerVMConfigPageWidget):
        ...
        self.gridLayout.addWidget(self.uiEnvironmentLabel, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.uiEnvironmentTextEdit, 6, 1, 1, 1)
    ...
    def retranslateUi(self, dockerVMConfigPageWidget):
        ...
        self.label.setText(_translate("dockerVMConfigPageWidget", "Category"))
