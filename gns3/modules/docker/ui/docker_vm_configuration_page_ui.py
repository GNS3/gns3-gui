...
class Ui_dockerVMConfigPageWidget(object):
    def setupUi(self, dockerVMConfigPageWidget):
        ...
        self.uiTabWidget = QtWidgets.QTabWidget(parent=dockerVMConfigPageWidget)
        ...
        self.uiCustomAdaptersConfigurationPushButton = QtWidgets.QPushButton(parent=self.tab)
        ...
        self.uiMaxMemoryLabel = QtWidgets.QLabel(parent=self.tab)
        self.uiMaxMemoryLabel.setObjectName("uiMaxMemoryLabel")
        self.gridLayout.addWidget(self.uiMaxMemoryLabel, 8, 0, 1, 1)
        self.uiMaxMemorySpinBox = QtWidgets.QSpinBox(parent=self.tab)
        ...
        self.uiMaxCPUsLabel = QtWidgets.QLabel(parent=self.tab)
        self.uiMaxCPUsLabel.setObjectName("uiMaxCPUsLabel")
        self.gridLayout.addWidget(self.uiMaxCPUsLabel, 9, 0, 1, 1)
        self.uiMaxCPUsDoubleSpinBox = QtWidgets.QDoubleSpinBox(parent=self.tab)
        ...
        self.uiAuxTypeLabel = QtWidgets.QLabel(parent=self.tab)
        self.uiAuxTypeLabel.setObjectName("uiAuxTypeLabel")
        self.gridLayout.addWidget(self.uiAuxTypeLabel, 11, 0, 1, 1)
        self.uiAuxTypeComboBox = QtWidgets.QComboBox(parent=self.tab)
        ...
        self.uiConsoleResolutionLabel = QtWidgets.QLabel(parent=self.tab)
        ...
        self.uiConsoleResolutionComboBox = QtWidgets.QComboBox(parent=self.tab)
        ...
        self.uiConsoleHttpPortSpinBox = QtWidgets.QSpinBox(parent=self.tab)
        ...
        self.uiHttpConsolePathLineEdit = QtWidgets.QLineEdit(parent=self.tab)
        ...
        self.uiEnvironmentLabel = QtWidgets.QLabel(parent=self.tab)
        self.uiEnvironmentLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.uiEnvironmentTextEdit = QtWidgets.QTextEdit(parent=self.tab)
        ...
        self.uiNetworkConfigLabel = QtWidgets.QLabel(parent=self.tab)
        self.uiNetworkConfigLabel.setObjectName("uiNetworkConfigLabel")
        self.gridLayout.addWidget(self.uiNetworkConfigLabel, 16, 0, 1, 1)
        self.uiNetworkConfigEditButton = QtWidgets.QPushButton(parent=self.tab)
        ...
        self.uiExtraHostsLabel = QtWidgets.QLabel(parent=self.tab_2)
        ...
        self.uiExtraHostsTextEdit = QtWidgets.QPlainTextEdit(parent=self.tab_2)
        ...
        self.uiExtraVolumeLabel = QtWidgets.QLabel(parent=self.tab_2)
        self.uiExtraVolumeLabel.setObjectName("uiExtraVolumeLabel")
        self.gridLayout_2.addWidget(self.uiExtraVolumeLabel, 1, 0, 1, 1)
        self.uiExtraVolumeTextEdit = QtWidgets.QPlainTextEdit(parent=self.tab_2)
        ...
        spacerItem = QtWidgets.QSpacerItem(20, 388, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
