...
class Ui_dockerVMConfigPageWidget(object):
    def setupUi(self, dockerVMConfigPageWidget):
        ...
        self.gridLayout.addWidget(self.uiNetworkConfigLabel, 14, 0, 1, 1)
        ...
        self.uiConsoleResolutionComboBox.addItem("")
        self.uiConsoleResolutionComboBox.addItem("")
        self.gridLayout.addWidget(self.uiConsoleResolutionComboBox, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.uiConsoleHttpPortSpinBox, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.uiEnvironmentLabel, 13, 0, 1, 1)
        self.uiEnvironmentTextEdit = QtWidgets.QTextEdit(self.tab)
        self.uiEnvironmentTextEdit.setObjectName("uiEnvironmentTextEdit")
        self.gridLayout.addWidget(self.uiEnvironmentTextEdit, 13, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.uiNetworkConfigEditButton, 14, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.uiConsoleResolutionLabel, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.uiHttpConsolePathLineEdit, 12, 1, 1, 1)
        ...
        self.uiAuxTypeComboBox.addItem("")
        self.gridLayout.addWidget(self.uiAuxTypeComboBox, 9, 1, 1, 1)
        self.uiAuxTypeLabel = QtWidgets.QLabel(self.tab)
        self.uiAuxTypeLabel.setObjectName("uiAuxTypeLabel")
        self.gridLayout.addWidget(self.uiAuxTypeLabel, 9, 0, 1, 1)
