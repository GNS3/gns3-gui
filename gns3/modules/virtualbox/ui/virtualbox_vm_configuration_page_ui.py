...
class Ui_virtualBoxVMConfigPageWidget(object):
    def setupUi(self, virtualBoxVMConfigPageWidget):
        ...
        self.uiTabWidget = QtWidgets.QTabWidget(parent=virtualBoxVMConfigPageWidget)
        ...
        self.uiVMListLabel = QtWidgets.QLabel(parent=self.tab)
        self.uiVMListLabel.setObjectName("uiVMListLabel")
        self.gridLayout.addWidget(self.uiVMListLabel, 5, 0, 1, 1)
        self.uiVMListComboBox = QtWidgets.QComboBox(parent=self.tab)
        ...
        self.uiVMRamLabel = QtWidgets.QLabel(parent=self.tab)
        self.uiVMRamLabel.setObjectName("uiVMRamLabel")
        self.gridLayout.addWidget(self.uiVMRamLabel, 6, 0, 1, 1)
        self.uiVMRamSpinBox = QtWidgets.QSpinBox(parent=self.tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
