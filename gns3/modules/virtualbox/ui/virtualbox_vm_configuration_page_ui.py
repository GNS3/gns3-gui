...
class Ui_virtualBoxVMConfigPageWidget(object):
    def setupUi(self, virtualBoxVMConfigPageWidget):
        ...
        virtualBoxVMConfigPageWidget.resize(774, 552)
        ...
        self.gridLayout.addWidget(self.uiACPIShutdownCheckBox, 7, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.uiHeadlessModeCheckBox, 8, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.uiBaseVMCheckBox, 9, 0, 1, 3)
        ...
        self.uiConsoleTypeComboBox.addItem("")
        self.gridLayout.addWidget(self.uiConsoleTypeComboBox, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.uiVMListComboBox, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.uiVMRamSpinBox, 6, 2, 1, 1)
