...
class Ui_TraceNGPreferencesPageWidget(object):
    def setupUi(self, TraceNGPreferencesPageWidget):
        ...
        self.uiTabWidget = QtWidgets.QTabWidget(parent=TraceNGPreferencesPageWidget)
        ...
        self.uiTraceNGPathLabel = QtWidgets.QLabel(parent=self.uiGeneralSettingsTabWidget)
        ...
        self.uiTraceNGPathLineEdit = QtWidgets.QLineEdit(parent=self.uiGeneralSettingsTabWidget)
        ...
        self.uiTraceNGPathToolButton = QtWidgets.QToolButton(parent=self.uiGeneralSettingsTabWidget)
        self.uiTraceNGPathToolButton.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextOnly)
        ...
        self.uiRestoreDefaultsPushButton = QtWidgets.QPushButton(parent=TraceNGPreferencesPageWidget)
