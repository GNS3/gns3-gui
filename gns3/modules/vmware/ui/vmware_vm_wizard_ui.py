...
class Ui_VMwareVMWizard(object):
    def setupUi(self, VMwareVMWizard):
        ...
        self.uiVMListLabel = QtWidgets.QLabel(parent=self.uiVMwareWizardPage)
        self.uiVMListLabel.setObjectName("uiVMListLabel")
        self.gridLayout.addWidget(self.uiVMListLabel, 0, 0, 1, 1)
        self.uiVMListComboBox = QtWidgets.QComboBox(parent=self.uiVMwareWizardPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.uiBaseVMCheckBox = QtWidgets.QCheckBox(parent=self.uiVMwareWizardPage)
