...
class Ui_iouDeviceConfigPageWidget(object):
    ...
    def retranslateUi(self, iouDeviceConfigPageWidget):
        ...
        self.uiConsoleTypeLabel.setText(_translate("iouDeviceConfigPageWidget", "Console type:"))
        self.uiConsoleTypeComboBox.setItemText(0, _translate("iouDeviceConfigPageWidget", "telnet"))
        self.uiConsoleTypeComboBox.setItemText(1, _translate("iouDeviceConfigPageWidget", "none"))
        self.uiConsoleAutoStartCheckBox.setText(_translate("iouDeviceConfigPageWidget", "Auto start console"))
